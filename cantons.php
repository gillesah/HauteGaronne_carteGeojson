...
<link rel='stylesheet' id='themify-builder-206-generated-css'  href='https://hautegaronneencommun.fr/wp-content/uploads/themify-css/themify-builder-206-generated.css?ver=1616958233' type='text/css' media='all' />
...
<script type='text/javascript' src='https://hautegaronneencommun.fr/wp-content/plugins/wp-mapbox-gl-js/public/js/wp-mapbox-gl-js-public.js?ver=899' id='wp-mapbox-gl-js-js'></script>
...
<link rel="https://api.w.org/" href="https://hautegaronneencommun.fr/wp-json/" /><link rel="alternate" type="application/json" href="https://hautegaronneencommun.fr/wp-json/wp/v2/pages/206" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="https://hautegaronneencommun.fr/xmlrpc.php?rsd" />
...
<link rel="canonical" href="https://hautegaronneencommun.fr/test/" />
<link rel='shortlink' href='https://hautegaronneencommun.fr/?p=206' />
<link rel="alternate" type="application/json+oembed" href="https://hautegaronneencommun.fr/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fhautegaronneencommun.fr%2Ftest%2F" />
<link rel="alternate" type="text/xml+oembed" href="https://hautegaronneencommun.fr/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fhautegaronneencommun.fr%2Ftest%2F&#038;format=xml" />
...
<section class="left">    
    <form action="">
      ...
      <input id="search" type="text" placeholder="Rechercher un canton ou un candidat ...">
    </form>
 <p>
...
try
{
	...
	$bdd = new PDO('mysql:host=lemeonhgec.mysql.db;dbname=lemeonhgec;charset=utf8', 'lemeonhgec', 'HGEClemeon2021departementales');
}
catch(Exception $e)
{
...
$reponse = $bdd->query('SELECT * FROM BDD_cantons');
while ($donnees = $reponse->fetch())

{
?>
 
  <div class="bloccanton">
 <ul><li>
   <div class="imgcantvign"><img src="https://hautegaronneencommun.fr/wp-content/uploads/2021/03/auterive.png" > </div>
   <div class="cantvigndrte"><a href="https://hautegaronneencommun.fr/canton/"><span class="cantontitre"><?php echo $donnees['Cantons']; ?> </span></br>
  </br><?php echo $donnees['conseil_1']; ?> </br> <?php echo $donnees['conseil_2']; ?> </div>
</li>
